...
export const products = [
    {
        id: "virgen-maria-25cm",
        name: "Virgen María en Yeso",
        subtitle: "Figura artesanal — 25cm de altura",
        category: "religioso",
        price: 8500,
        stock: "disponible",
        sizes: ["15cm", "25cm", "35cm"],
        description:
            "Figura artesanal de la Virgen María realizada en yeso de alta calidad. Cada pieza es moldeada y pintada a mano en nuestro taller de San Miguel. Ideal como regalo religioso o para decorar altares y hornacinas. Disponible para personalización de colores y detalles.",
        images: ["/images/products/virgen-maria.jpg"],
        tags: ["religioso", "virgen", "regalo", "San Miguel"],
        slug: "virgen-maria-25cm",
    },
    {
        id: "san-miguel-arcangel",
        name: "San Miguel Arcángel",
        subtitle: "Figura artesanal — 30cm de altura",
        category: "religioso",
        price: 10500,
        stock: "disponible",
        sizes: ["20cm", "30cm", "40cm"],
        description:
            "Imponente figura de San Miguel Arcángel en yeso pintado a mano. Patrón de San Miguel, Buenos Aires. Detallado acabado artesanal que resalta la espada y la armadura. Perfecta como protección del hogar.",
        images: ["/images/products/san-miguel.jpg"],
        tags: ["religioso", "arcángel", "San Miguel", "protección"],
        slug: "san-miguel-arcangel",
    },
    {
        id: "angel-guarda-mini",
        name: "Ángel de la Guarda Mini",
        subtitle: "Souvenir artesanal — 10cm",
        category: "souvenirs",
        price: 3500,
        stock: "disponible",
        sizes: ["10cm"],
        description:
            "Mini ángel guardián ideal como souvenir para comuniones, bautismos y confirmaciones. Se puede personalizar con nombre y fecha grabados en la base.",
        images: ["/images/products/angel-mini.jpg"],
        tags: ["souvenir", "comunión", "bautismo", "personalizable"],
        slug: "angel-guarda-mini",
    },
    {
        id: "kit-diy-basico",
        name: "Kit DIY Pintura Básico",
        subtitle: "Incluye figura + pinturas + pincel",
        category: "kits",
        price: 4200,
        stock: "disponible",
        sizes: ["único"],
        description:
            "Kit completo para pintar tu propia figura de yeso en casa. Incluye figura sin pintar (virgen o ángel a elección), set de pinturas acrílicas artesanales y pincel de precisión. Ideal para niños y adultos.",
        images: ["/images/products/kit-diy.jpg"],
        tags: ["kit", "DIY", "pintura", "niños", "actividad"],
        slug: "kit-diy-basico",
    },
    {
        id: "centro-mesa-bautismo",
        name: "Centro de Mesa Bautismo",
        subtitle: "Decoración artesanal — set de 5 piezas",
        category: "decoracion",
        price: 11000,
        stock: "ultimas",
        sizes: ["único"],
        description:
            "Elegante set de 5 piezas de yeso para decoración de mesas de bautismo. Incluye 2 palomas, 1 cruz, 1 ángel y 1 corazón. Todos pintados en blanco con detalles dorados.",
        images: ["/images/products/bautismo-set.jpg"],
        tags: ["decoración", "bautismo", "evento", "centro de mesa"],
        slug: "centro-mesa-bautismo",
    },
    {
        id: "santos-de-asis",
        name: "San Francisco de Asís",
        subtitle: "Figura artesanal — 22cm",
        category: "religioso",
        price: 7800,
        stock: "disponible",
        sizes: ["22cm", "32cm"],
        description:
            "Figura de San Francisco de Asís en yeso pintado a mano. Detallado hábito franciscano y pajarito en la mano. Ideal para jardines y hogares con mascotas.",
        images: ["/images/products/san-francisco.jpg"],
        tags: ["religioso", "santo", "jardín", "coleccionable"],
        slug: "santos-de-asis",
    },
    {
        id: "kit-diy-premium",
        name: "Kit DIY Premium Navidad",
        subtitle: "Nacimiento completo para pintar",
        category: "kits",
        price: 8900,
        stock: "disponible",
        sizes: ["único"],
        description:
            "Kit completo de nacimiento navideño para pintar. Incluye 7 figuritas (María, José, Niño Jesús, Reyes Magos), pinturas y pinceles. Actividad ideal en familia.",
        images: ["/images/products/kit-navidad.jpg"],
        tags: ["kit", "navidad", "nacimiento", "familia"],
        slug: "kit-diy-premium",
    },
    {
        id: "souvenir-cumple-15",
        name: "Souvenirs Cumpleaños de 15",
        subtitle: "Personalizables — precio por unidad (mín. 20)",
        category: "souvenirs",
        price: 2800,
        stock: "disponible",
        sizes: ["8cm"],
        description:
            "Mini figuras de yeso para souvenirs de quinceañeros. Incluye silueta femenina con vestido de fiesta, personalizable con nombre y fecha en la base. Pedido mínimo 20 unidades.",
        images: ["/images/products/souvenir-15.jpg"],
        tags: ["souvenir", "cumpleaños", "quince", "personalizable"],
        slug: "souvenir-cumple-15",
    },
    {
        id: "angel-decorativo-grande",
        name: "Ángel Decorativo de Hogar",
        subtitle: "Decoración artesanal — 40cm",
        category: "decoracion",
        price: 15000,
        stock: "disponible",
        sizes: ["40cm"],
        description:
            "Majestuoso ángel decorativo de 40cm para el hogar. Acabado en blanco yeso con detalles dorados. Perfecto para entrada, living o jardín. Pieza única artesanal de San Miguel.",
        images: ["/images/products/angel-grande.jpg"],
        tags: ["decoración", "hogar", "ángel", "deco"],
        slug: "angel-decorativo-grande",
    },
    {
        id: "nacimiento-navidad",
        name: "Nacimiento Navideño Completo",
        subtitle: "Set de 9 piezas — pintado a mano",
        category: "decoracion",
        price: 22000,
        stock: "ultimas",
        sizes: ["único"],
        description:
            "Nacimiento navideño completo en yeso pintado a mano. 9 piezas que incluyen la Sagrada Familia, los Reyes Magos, pastores y animales. Tamaño: figuras entre 12 y 18cm.",
        images: ["/images/products/nacimiento.jpg"],
        tags: ["navidad", "nacimiento", "decoración", "regalo"],
        slug: "nacimiento-navidad",
    },
    {
        id: "virgen-lourdes",
        name: "Virgen de Lourdes",
        subtitle: "Figura artesanal — 28cm",
        category: "religioso",
        price: 9200,
        stock: "disponible",
        sizes: ["15cm", "28cm", "38cm"],
        description:
            "Figura de la Virgen de Lourdes con gruta y peana incluida. Pintada a mano con colores tradicionales — manto azul y túnica blanca. Ideal para hornacinas y jardines.",
        images: ["/images/products/virgen-lourdes.jpg"],
        tags: ["religioso", "virgen", "Lourdes", "jardín"],
        slug: "virgen-lourdes",
    },
    {
        id: "souvenir-comunion",
        name: "Souvenir Primera Comunión",
        subtitle: "Caliz con hostia — personalizable",
        category: "souvenirs",
        price: 3200,
        stock: "disponible",
        sizes: ["10cm"],
        description:
            "Souvenir en yeso de cáliz con hostia para Primera Comunión. Base personalizable con nombre y fecha del niño. Presentación individual en cajita de regalo. Pedido mínimo 10 unidades.",
